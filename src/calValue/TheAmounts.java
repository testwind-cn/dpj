...
public class TheAmounts {
	...
	public void  cal_theAmounts( TheRates theRates, double all_loan )
	{
		...
		for ( int x=1; x <= num; x++) {
			...
			d_Amounts[x] =  amt;
			d_DueInterests[x] = theRates.cal_Period_Interest(x, amt,false );
		...
		amt = d_Amounts[  num ];
		d_DueInterests[ num ] = theRates.cal_Period_Interest( num , amt,false );
